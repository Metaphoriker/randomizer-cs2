...
import dev.luzifer.gui.view.views.OldBuilderView;
...
public class AppStarter extends Application {
    ...
    public void start(Stage stage) {
        ...
        viewController.showView(new SelectionView(new SelectionViewModel(
                ...
                () -> viewController.showView(new OldBuilderView(new BuilderViewModel(Main.getEventRepository(), Main.getEventClusterRepository()))))));
    }
