package de.metaphoriker.view.game;

import de.metaphoriker.util.CSSUtil;
import de.metaphoriker.util.ImageUtil;
import de.metaphoriker.view.game.objects.sub.EnemyObject;
import de.metaphoriker.view.game.objects.sup.ItemObject;
import de.metaphoriker.view.game.objects.sup.entity.Entity;
...
public class GameWindow extends Pane {
  ...
  private void setupPlayer() {
    ...
    setOnKeyReleased(player::onReleaseKey);
    setOnMouseMoved(player::onMouseMove);
    setOnMousePressed(player::onMouseClick);
