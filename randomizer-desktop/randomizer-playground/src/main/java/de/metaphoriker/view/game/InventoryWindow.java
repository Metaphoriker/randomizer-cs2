...
public class InventoryWindow extends VBox {
  ...
  public InventoryWindow(Pane parent, Player player) {
    ...
    flowPane.setBackground(
        ImageUtil.getBackground(
            "images/game/inventory_background.jpg")); // TODO: Make this png for consistency
  ...
  private void fill() {
    ...
    flowPane
        .getChildren()
        .clear(); // TODO: Give each item their own images or cache them and reference to them
